 ...
 * Netty客户端侧处理器
 */
public class NettyClientHandler extends SimpleChannelInboundHandler<CoapResponse> {
    ...
    public void userEventTriggered(ChannelHandlerContext ctx, Object evt) throws Exception {
        if (evt instanceof IdleStateEvent) {
            ...
            if (state == IdleState.WRITER_IDLE) {
                ...
                CoapRequest.setHeartBeat(true);
                channel.writeAndFlush(CoapRequest).addListener(ChannelFutureListener.CLOSE_ON_FAILURE);
            }
        } else {
